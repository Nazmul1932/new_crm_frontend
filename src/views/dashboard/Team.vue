    ...
    <div class="container">
        <div class="columns is-multiline">
            ...
            <div class="column is-12">
                ...
                <p><strong>Clients: </strong>{{ $store.state.team.max_clients }}</p>
                <p><strong>Leads: </strong>{{ $store.state.team.max_leads }}</p>

                <p>
                    <router-link :to="{'name': 'Plans'}" class="button is-primary">Change Plan</router-link>
                </p>
